...
#ifndef LOGGING_LOG_WRITER_TESTS_
#define LOGGING_LOG_WRITER_TESTS_
...
int time_delta_in_seconds(std::tm& check_date)
{
	...
	{	if (environment_timezone) setenv("TZ", environment_timezone, 1);
		else unsetenv("TZ");
		tzset();
	} 	BOOST_SCOPE_EXIT_END
...
#endif // LOGGING_LOG_WRITER_TESTS_
